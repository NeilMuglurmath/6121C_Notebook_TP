				...
				\subsubsection{Control System}
					\begin{itemize}
						...
						\begin{itemize}
							...
							\item Even though the V5 has these positives, it is still true that V5 has not been used in compeition yet. There could be many unadressed issues in V5. Also, being that V5 is a newly released system, there is not nearly as much information about it online than there is about the Cortes system. Also, since many teams want the V5 system, there could potentially be a backorder on V5 products.
						\end{itemize}

						\bigskip
							\textbf{Verdict}
							Even though CHS Robotics is used to using the tried-and-true Cortex control system, its negatives outweigh the positives. The Cortex is buggy and unreliable sometimes, and this cannot be an issue for us this year.
					\end{itemize}

			\newpage
				\subsubsection{Drivetrains}
					\begin{itemize}

						%H-Drive
						\item H-Drive
						\begin{figure}[H]
							\includegraphics[width=\linewidth]{{images/H_Drive}} % schoology post
					...
					\newpage
						\item X-Drive
						\begin{figure}[H]
							\includegraphics[width=\linewidth]{{images/X_Drive}} % schoology post
						...
						\begin{itemize}
							...
							\begin{figure}[H]
								\includegraphics[width=\linewidth]{{images/X_Drive_Vector}} % schoology post
								\caption{CAD model of a widely used X-Drive drivetrain design.}
							...
							\qquad The module configuration creates a $\sqrt{2}:1$ ratio for speed.
						\end{itemize}
					\end{itemize}
